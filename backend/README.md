...
## Project Structure
    ...
    ├── testapiautosetting_125685  # Django project configurations
...
1. Clone this repo and `cd testapiautosetting_125685`
...
2. Clone this repo and `cd testapiautosetting_125685`
